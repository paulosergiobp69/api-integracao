...
class AlterPurchaseHistOrdersCargaOrdemEmgenciaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        echo "Carga Ordem de Compra Emergencia \n";
